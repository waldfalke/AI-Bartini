...
| Решение смыслового, организационного или экономического противоречия | Возможен исследовательский перенос по аналогии, но не доказательство через физику. Соответствия и проверка вывода задаются отдельно. |

**Примеры:** искать способы одновременно облегчить и усилить деталь — подходящая
постановка. Получить точную толщину или рецепт смеси из одной таблицы — нет.
В задаче о материалах можно исследовать теплообмен, перенос и геометрию, но название
нужной молекулы не выводится из LT-адреса.

В смешанной задаче физическую часть и смысловую интерпретацию разбирают раздельно.
Нефизический перенос не запрещён; его статус — гипотеза, а не установленный закон.
